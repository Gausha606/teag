...
export default function page() {
  return (
    <div className=" mt-16 relative" > 
      <div  className="flex flex-col justify-center items-center h-[700px] min-h-screen" id="menu-card">
      <p className="text-5xl  text-white font-bold m-0">
        Our Menu
      </p>
      ...
      <div className="sticky top-16 z-50 bg-white shadow-lg w-full">
       ...
       <div id="menu-card">
      <div className="flex flex-col gap-4  w-[1100px] mx-auto pb-8 relative z-10">
        {/* beverages page */}
        <section
          id="beverages"
        ...
        >
          ...
          <p className="text-xl w-[700px] text-center text-white  pb-8 montserrat ">
            Freshly squeezed juices and exquisite coffee brews await to refresh your senses.
          </p>
    ...
    {/* <div className="border-gray-700 border-b-1 w-full mb-6 "></div> */}
        ...
        >
          ...
          <p className="text-xl w-[700px] text-center text-white  pb-8 montserrat ">
            Crafted to satisfy your cravings, our main courses are a celebration of culinary excellence.
          </p>
          <MainCourseCarousel />
