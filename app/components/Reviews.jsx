      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          <div className="text-center">
            <h2 className="text-2xl font-bold  sm:!text-5xl xl:text-5xl ">
              What Our Guests Say
            </h2>
            <p className="text-lg font-medium  font-pj !mt-8">
          ...
          <div className="relative mt-10 md:mt-12 md:order-2">
            ...
            <span className="group">
              <div className="flex flex-row sm:flex-col  overflow-hidden border-1 border-[#A84D06] shadow-xl duration-300 group-hover:scale-105 group-hover:text-white rounded-xl">
            ...
            <span className="group">
              <div className="flex flex-row sm:flex-col  overflow-hidden border-1 border-[#A84D06] shadow-xl duration-300 group-hover:scale-105 rounded-xl">
