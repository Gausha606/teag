...
export default function OurStory() {
  return (
    <div className="flex justify-between  bg-black py-12">

         <div className="mx-8">
        <h1 className="text-white !text-5xl font-bold">Our Philosophy</h1>

        <div className="w-[700px] text-white mt-8 flex flex-col gap-4 montserrat ">
          <p className="m-0">
      ...
      <div className="w-1/2 h-[400px] flex justify-center items-center overflow-hidden rounded-2xl shadow-lg mx-8">
        <Image
