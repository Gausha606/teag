...
export default function Menuimage() {
  return (
    <section className="min-h-screen py-12 relative" id="card">
      ...
      <div className="relative z-[2]">
        <p className="text-center text-5xl pt-20 pb-24 font-bold text-white">
          Delicious Food is waiting for you
        </p>
        <div className="flex justify-around pb-12 gap-12 ">
          <div className="flex !flex-col justify-center items-center bg-[#ffffff] rounded-2xl mx-12 py-8 gap-3 hover:scale-101 hover:shadow-2xl duration-300 ease-in-out">
            <p className="w-[500px] text-center text-xl montserrat px-12 m-0">
            ...
            <p className=" w-[500px] text-center text-xl px-12 montserrat m-0">
          ...
          <div className="relative hover:scale-105 duration-300 ease-in-out">
            <Image
              src={beverages}
              className="absolute top-20 left-[-100px] rotate-45"
              width={280}
              alt="Beverages section"
            />
            <Image
              src={starters}
              className="absolute top-5 rotate-90"
              width={280}
              alt="Starters section"
            />
            <Image
              src={intro}
              className="relative mt-20 mr-64 z-30"
              width={280}
              alt="Intro section"
            />
            <Image
              src={mc}
              className="absolute top-20 right-[150px] rotate-305 "
              width={280}
              alt="Main Course section"
            />
            <Link href="/menu">
              <button className="absolute !top-72 left-13 px-3 cursor-pointer !mr-4 py-2 bg-[#A84D06] !rounded-lg text-white montserrat hover:shadow-2xl hover:scale-105 duration-300 ease-in-out">
                Explore Full Menu
              </button>
            </Link>
          </div>
